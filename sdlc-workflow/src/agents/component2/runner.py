"""Component 2 execution runner — builds AgentContext and drives the LangGraph."""
...
from .graph import build_component2_graph


async def run_component2(
    ...
    graph = build_component2_graph(ctx)
