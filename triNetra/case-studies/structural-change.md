# Case Study: Structural Change

**Domain:** Enterprise Cybersecurity  
**Assessment type:** Change Analysis  
**Finding:** +27 Eagle Score across two structural versions of the same system

[View interactive sample →](https://trinetra.life/manifest-comparison-sample)
...
The Change Analysis answers the question organisations ask after a structural revision: did the changes work, and which specific changes produced which specific improvements?

Without a deterministic assessment instrument, the only answer to that question is opinion. With the Eagle Framework, the answer is a scored, evidence-grounded finding that attributes each point of gain to a specific structural change.

This is also the mechanism for tracking ROI on structural improvement investments: the organisation knows exactly which changes moved the Eagle Score, which changes had no structural effect, and which structural gaps remain unaddressed after the revision.
