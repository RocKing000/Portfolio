...
PaaF does not produce strategy decks, implementation plans, vendor recommendations, or technology roadmaps. It produces structural instruments: governed frameworks, pattern maps, and structural diagnoses that the organisation or institution can use to govern itself independently.

The methodology assumes that the first identified problem is not necessarily the actual problem. Resolution begins at the symptom layer and works downward until the source structural condition is located.
