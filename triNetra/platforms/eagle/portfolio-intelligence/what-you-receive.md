...
## Cross-Portfolio Structural Pattern Analysis

An analysis of structural patterns that repeat across multiple portfolio companies. Identifies which Eagle Framework dimension gaps are systemic across the portfolio rather than isolated to individual companies.
...
## Portfolio Structural Evolution Tracking

For EPS clients across multiple assessment cycles, Portfolio Intelligence tracks how the structural profile of the portfolio changes over time. Identifies:

- Whether portfolio-wide Eagle Scores are improving, stable, or deteriorating
- Which companies have driven the most structural improvement
- Whether new investments have changed the portfolio's structural risk profile

---

## What It Does Not Do

Portfolio Intelligence does not produce investment recommendations, divestment advice, or valuation adjustments. It produces a structural diagnosis of the portfolio as a system, which the institutional client uses to inform its own portfolio management decisions.
