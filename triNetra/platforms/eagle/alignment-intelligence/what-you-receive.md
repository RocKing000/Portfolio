...
A structured breakdown of where the assessed company diverges from the institutional standard. Each gap is:

- Mapped to a specific Eagle Framework dimension
- Grounded in evidence from the Input Manifest
- Prioritised by gap severity
- Accompanied by the specific criterion it fails to meet

The Gap Analysis gives the institutional client a structured basis for portfolio engagement: which companies need to address what, at the structural level.
