...
The Reference Manifest is the mechanism by which an institutional client encodes its investment criteria and structural expectations into the Alignment Intelligence process.
...
The institutional client defines its investment criteria and structural expectations once. The triNetra Research Studio translates these into a Reference Manifest structured to the Eagle Framework dimension schema.

The process surfaces questions the institution may not have previously formalised: what level of evidence attribution do we actually require? What human oversight configuration is acceptable? What incident reconstruction capability is non-negotiable?
...
The Reference Manifest accumulates institutional value over time. It can be:

- **Versioned** as the investment thesis evolves
...
The Reference Manifest is defined and owned by the institutional client. Portfolio companies do not have access to it. They submit their Input Manifest describing their own system. The assessment evaluates the two independently and produces the Alignment Score and Gap Analysis from the comparison.

This preserves the integrity of the institutional standard.
